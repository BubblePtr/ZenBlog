export const zh = {
  ...
  'home.hero.bio': '独立开发者，终身学习者。执着于文字的力量，敬畏于未知的边界。',
  'home.hero.intro': '记录软件工程、AI 产品与独立开发，也把一些正在发生的项目和观察留在这里。',
  'home.photography': '摄影',
  'home.projects': '项目',
  'home.projects.description':
    '我信奉实用主义但也对好看有着偏执，希望打磨出好看又好用的产品，把已有的一些实践和成果记录在这里。',
  'home.writing.description': '分享我在软件工程、AI 与产品实践中的思考、复盘与方法论。',
  'home.photography.description':
    '不知道什么时候开始，需要用力地从记忆深处找寻一些时光碎片，这些照片是我与世界的交互，也留下一些我来过的痕迹。',

  // 博客页
  'blog.title': '文章',
  'blog.description':
    '所谓算法，大抵是这时代的新的迷信。人们拜倒在二进制的神庙里，却忘了最初不过是要算清几斤白菜的账。',
